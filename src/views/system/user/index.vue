  ...
  <div class="app-container">
        ...
        <pane size="84">
          <el-col>
            ...
            <el-row :gutter="10" class="mb8">
              ...
              <right-toolbar v-model:showSearch="showSearch" @query-table="getList" :columns="columns"></right-toolbar>
            </el-row>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="真实姓名" prop="realName">
              <el-input v-model="form.realName" placeholder="请输入用户真实姓名" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
