!(function () {
  ...
  const Me = e => t => l(t) && t.nodeName.toLowerCase() === e,
    ...
    Ye = (e, t, n = {}) => {
      ...
      let a,
        ...
        c = !1
      for (
        d = o.create(i, { ...l, ...(n.style ? { style: n.style } : {}) }), ze(t.firstChild, r) || s.appendChild(d);
        (a = t.firstChild);

      ) {
        const e = a.nodeName
        c || ('SPAN' === e && 'bookmark' === a.getAttribute('data-mce-type')) || (c = !0),
          ze(a, r) ? (s.appendChild(a), (d = null)) : (d || ((d = o.create(i, l)), s.appendChild(d)), d.appendChild(a))
      }
    ...
    Ct = (e, t) => {
      ...
      return t({ parents: e.dom.getParents(n), element: n }), e.on('NodeChange', t), () => e.off('NodeChange', t)
    },
        ...
        D(o).each(t => {
          if (Lt(n)) {
            ...
            ;((e, t) => {
              ...
              ((e, t) => {
                J(e.list) !== t.listType && (e.list = Ce(e.list, t.listType)), ge(e.list, t.listAttributes)
              })(t, n)
          ...
          Ot(o)
            ...
            : o.depth > t.length
              ? ((e, t, n) => {
                  const o = ((e, t, n) => {
                    const o = []
                    for (let r = 0; r < n; r++) o.push(Et(e, Lt(t) ? t.listType : t.parentListType))
                    return o
                  ...
                  return (
                    ...
                    ((e, t) => {
                      for (let t = 0; t < e.length - 1; t++) Se(e[t].item, 'list-style-type', 'none')
                      D(e).each(e => {
                        Lt(t) && (ge(e.list, t.listAttributes), ge(e.item, t.itemAttributes)), pe(e.item, t.content)
                      })
                    })(o, n),
                    (r = o),
                    U(D(t), w(r), kt),
    ...
    Bt = e => (
      S(e, (t, n) => {
        ;((e, t) => {
          ...
          e => {
            return (
              (o = e), void (Lt((n = t)) && Lt(o) && ((n.listType = o.listType), (n.listAttributes = { ...o.listAttributes })))
            )
            var n, o
          }
        )
          ...
          r => {
            const s = O(
              ...
              (o, s, i) => {
                ...
                {
                  const t = { isFragment: !0, depth: e, content: [s], isSelected: !1, dirty: !1, parentListType: J(r) }
                  return o.concat(t)
                }
              },
              []
    ...
    Ut = (e, t) => {
      const n = be(
          (e => {
            ...
            return T(n, e => {
              return (t = z(e)), se(t).exists(e => He(e.dom) && ae(e).exists(e => !Ue(e.dom)) && de(e).exists(e => !Ue(e.dom)))
              var t
            }).fold(
              () => gt(e, t),
              e => [e]
  ...
  const jt = De.DOM,
    ...
    zt = e => {
        ...
        if (n) {
          if (Re(n) && n.parentNode) {
            ...
            ;(o = (e => {
              ...
              for (; n; ) {
                if (n === e) return o
                ;(Re(n) && 'bookmark' === n.getAttribute('data-mce-type')) || o++, (n = n.nextSibling)
              }
              return -1
            })(n)),
              (n = n.parentNode),
      ...
      return n.setStart(e.startContainer, e.startOffset), e.endContainer && n.setEnd(e.endContainer, e.endOffset), it(n)
    },
    Qt = e => {
      switch (e) {
        case 'UL':
    ...
    Gt = (e, t, n, o) => {
      ...
      Re(r) && (r = r.childNodes[Math.min(s, r.childNodes.length - 1)] || r), !n && je(r.nextSibling) && (r = r.nextSibling)
      const i = (t, n) => {
        var r
        const s = new Ee(
            t,
        ...
        let l
        for (; (l = s[i]()); )
          if (!Qe(e, l) && !F(l.textContent) && 0 !== (null === (r = l.textContent) || void 0 === r ? void 0 : r.length))
            return h.some(l)
        return h.none()
      }
      if (n && Ie(r))
            ...
            return (
              Be.each(a, t => {
                ...
                Vt.isBookmarkNode(t) && (Ue(i) || Ke(e, i) || (!i && t.parentNode === n))
                  ? (l = null)
                  : (l || ((l = r.create('p')), null === (s = t.parentNode) || void 0 === s || s.insertBefore(l, t), o.push(l)),
                    l.appendChild(t))
              }),
              o
            )
    ...
    Xt = (e, t, n) => {
      return (
        ...
        ((e, t, n) => e.getStyle(t, 'list-style-type', !0) === e.getStyle(n, 'list-style-type', !0))(e, t, n) &&
      ...
      Be.each(n, t => {
        ;((e, t) => {
          ...
          if (n && 'LI' === n.nodeName && n.firstChild === t) {
            ...
            o && 'LI' === o.nodeName ? (o.appendChild(t), We(e, n) && rn.remove(n)) : rn.setStyle(n, 'listStyleType', 'none')
          }
          if (Ue(n)) {
    ...
    ln = (e, t, n, o) => {
      ...
      const l = new Ee(r, o)
      n && ((e, t) => !!je(t) && e.isBlock(t.nextSibling) && !je(t.previousSibling))(e.dom, r) && l.next()
    ...
    mn = (e, t, n) => {
      ...
      Ue(n.lastChild) && (o = n.lastChild), r === n.lastChild && je(r.previousSibling) && e.remove(r.previousSibling)
      const s = n.lastChild
      s && je(s) && t.hasChildNodes() && e.remove(s), We(e, n, !0) && fe(z(n)), cn(e, t, n), o && n.appendChild(o)
      const i = ((e, t) => {
        const n = e.dom,
          o = t.dom
        ...
        (n.isCollapsed()
          ...
          : (e =>
              ...
              (e.undoManager.transact(() => {
                let t = !0
                const n = () => (t = !1)
                e.on('input', n), e.execCommand('Delete'), e.off('input', n), t && e.dispatch('input'), sn(e.dom, e.getBody())
              }),
              !0))(e))
      )
    },
    ...
    yn = e => {
      ...
      return R(e.listStyleType, 'upper-alpha') ? fn(t) : R(e.listStyleType, 'lower-alpha') ? fn(t).toLowerCase() : e.start
    },
    vn = (e, t) => () => {
      const n = dt(e)
        ...
        ;(e => {
          ...
          _e(t) &&
            ...
            e.windowManager.open({
              ...
              body: {
                type: 'panel',
                items: [{ type: 'input', name: 'start', label: 'Start list at number', inputMode: 'numeric' }]
              },
              initialData: {
                start: yn({
              ...
              onSubmit: t => {
                ;(e => {
                  switch (
                    (e => (/^[0-9]+$/.test(e) ? 2 : /^[A-Z]+$/.test(e) ? 0 : /^[a-z]+$/.test(e) ? 1 : e.length > 0 ? 4 : 3))(e)
                  ) {
                    case 2:
                      return h.some({ listStyleType: h.none(), start: e })
                    case 0:
                      return h.some({ listStyleType: h.some('upper-alpha'), start: hn(e).toString() })
                    case 1:
                      return h.some({ listStyleType: h.some('lower-alpha'), start: hn(e).toString() })
                    case 3:
                ...
                r(n) &&
                  ((e, t) => {
                    ...
                    null === n ||
                      vt(e, n) ||
                      e.undoManager.transact(() => {
                        r(t.styles) && e.dom.setStyles(n, t.styles), r(t.attrs) && P(t.attrs, (t, o) => e.dom.setAttrib(n, o, t))
                      })
                  })(e, n)
              }),
