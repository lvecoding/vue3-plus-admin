!(function () {
  ...
  const o = e => t => t.options.get(e),
    ...
    l = (e, t, o, n) => {
      var s
      const i = parseInt(null !== (s = e.getStyle(t, o, n)) && void 0 !== s ? s : '', 10)
      return isNaN(i) ? 0 : i
    },
    a = (e, o, r, c) => {
      var d
      const u = e.dom,
        h = e.getDoc()
      if (!h) return
      if ((e => e.plugins.fullscreen && e.plugins.fullscreen.isFullscreen())(e)) return void g(e, !0)
      const m = h.documentElement,
        f = c ? c() : i(e),
        p = null !== (d = n(e)) && void 0 !== d ? d : e.getElement().offsetHeight
      let y = p
      const S = l(u, m, 'margin-top', !0),
        v = l(u, m, 'margin-bottom', !0)
      let C = m.offsetHeight + S + v + f
      C < 0 && (C = 0)
      const H = e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight
      C + H > p && (y = C + H)
      const b = s(e)
      b && y > b ? ((y = b), g(e, !0)) : g(e, !1)
      const w = o.get()
      if (
        (w.set &&
          (e.dom.setStyles(e.getDoc().documentElement, { 'min-height': 0 }),
          e.dom.setStyles(e.getBody(), { 'min-height': 'inherit' })),
        y !== w.totalHeight && (C - f !== w.contentHeight || !w.set))
      ) {
        const n = y - w.totalHeight
        if (
          (u.setStyle(e.getContainer(), 'height', y + 'px'),
          o.set({ totalHeight: y, contentHeight: C, set: !0 }),
          (e => {
        ...
        e.hasFocus() &&
          ...
          (t.browser.isSafari() || t.browser.isChromium()) && n < 0 && a(e, o, r, c)
      }
    }
  e.add('autoresize', e => {
    if (
      ...
      const o = (() => {
        let e = { totalHeight: 0, contentHeight: 0, set: !1 }
        return {
          get: () => e,
          set: t => {
            e = t
