!(function () {
  ...
  const n = t => t,
    ...
    f = (t, e) => {
      ...
      return (
        ...
        ((3 !== n && 1 !== n) || 4 !== o || 4 !== c) &&
        (4 !== n || (3 !== o && 1 !== o) || 4 !== r) &&
        ((8 !== n && 9 !== n) || (0 !== o && 4 !== o && o !== y && 8 !== o && 9 !== o)) &&
        ((8 !== o && (9 !== o || (0 !== r && 4 !== r && r !== y && 8 !== r && 9 !== r))) ||
          (0 !== n && 4 !== n && n !== y && 8 !== n && 9 !== n)) &&
        (5 !== n || 6 !== o) &&
        (7 === n ||
          5 === n ||
      ...
      ((t, e, n) => {
        ...
        return ((t, e, n, o) => {
          ...
          for (let s = 0; s < n.length; ++s)
            if ((u.push(t[s]), f(n, s))) {
              const n = e[s]
              if ((o.includeWhitespace || !E.test(n)) && (o.includePunctuation || !R.test(n))) {
                ...
                '.' === e[s + 1] && /^([a-zA-Z]\.)+$/.test(a + '.')
                  ? (u.push(t[s + 1]), c.push({ start: n, end: o + 1 }))
                  : c.push({ start: n, end: o }),
                  r.push(u)
              }
              u = []
            }
  ...
  const T = (t, e) => {
      ...
      const s = new F(t, t)
      let a
      for (; (a = s.next()); ) 3 === a.nodeType ? (u += a.data.replace(/\uFEFF/g, '')) : r(a) && u.length && (c.push(u), (u = ''))
  ...
  ;((e = 300) => {
    t.add('wordcount', t => {
      const n = (t => ({
        body: { getWordCount: M(t), getCharacterCount: k(t, D), getCharacterCountWithoutSpaces: k(t, j) },
        selection: { getWordCount: U(t, B), getCharacterCount: U(t, D), getCharacterCountWithoutSpaces: U(t, j) },
        getCount: M(t)
      }))(t)
      return (
        ((t, e) => {
                  ...
                  items: [
                    {
                      ...
                      cells: [
                        ['Words', String(e.body.getWordCount()), String(e.selection.getWordCount())],
                        [
                          'Characters (no spaces)',
                          String(e.body.getCharacterCountWithoutSpaces()),
                          String(e.selection.getCharacterCountWithoutSpaces())
                        ],
                        ['Characters', String(e.body.getCharacterCount()), String(e.selection.getCharacterCount())]
                      ]
                    }
                  ]
                },
        ...
        (t => {
          ...
          t.ui.registry.addButton('wordcount', { tooltip: 'Word count', icon: 'character-count', onAction: e, context: 'any' }),
            t.ui.registry.addMenuItem('wordcount', { text: 'Word count', icon: 'character-count', onAction: e, context: 'any' })
        })(t),
        z(t, n, e),
        n
      )
