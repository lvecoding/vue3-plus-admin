!(function () {
  ...
  const t = e => t => t.options.get(e),
    ...
    c = (e, t) => {
      if ((e = '' + e).length < t) for (let a = 0; a < t - e.length; a++) e = '0' + e
      return e
    },
    d = (e, t, a = new Date()) =>
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace(
        '%r',
        '%I:%M:%S %p'
      )).replace('%Y', '' + a.getFullYear())).replace('%y', '' + a.getYear())).replace('%m', c(a.getMonth() + 1, 2))).replace(
        '%d',
        c(a.getDate(), 2)
      )).replace('%H', '' + c(a.getHours(), 2))).replace('%M', '' + c(a.getMinutes(), 2))).replace(
        '%S',
        '' + c(a.getSeconds(), 2)
      )).replace('%I', '' + (((a.getHours() + 11) % 12) + 1))).replace('%p', a.getHours() < 12 ? 'AM' : 'PM')).replace(
        '%B',
        '' + e.translate(m[a.getMonth()])
      )).replace('%b', '' + e.translate(l[a.getMonth()]))).replace('%A', '' + e.translate(o[a.getDay()]))).replace(
        '%a',
        '' + e.translate(i[a.getDay()])
      )).replace('%%', '%'),
    u = (e, t) => {
      if (s(e) && e.selection.isEditable()) {
        const a = d(e, t)
        let n
  ...
  e.add('insertdatetime', e => {
    ;(e => {
      ...
      t('insertdatetime_dateformat', { processor: 'string', default: e.translate('%Y-%m-%d') }),
        t('insertdatetime_timeformat', { processor: 'string', default: e.translate('%H:%M:%S') }),
        t('insertdatetime_formats', { processor: 'string[]', default: ['%H:%M:%S', '%Y-%m-%d', '%I:%M:%S %p', '%D'] }),
      ...
      (e => {
        ...
        e.ui.registry.addSplitButton('insertdatetime', {
          ...
          select: e => e === a.get(),
          fetch: a => {
            a(p.map(t, t => ({ type: 'choiceitem', text: d(e, t), value: t })))
          },
          onAction: e => {
            s(a.get())
          },
        ...
        e.ui.registry.addNestedMenuItem('insertdatetime', {
          icon: 'insert-time',
          text: 'Date/time',
          getSubmenuItems: () => p.map(t, t => ({ type: 'menuitem', text: d(e, t), onAction: i(t) })),
          onSetup: g(e)
        })
      })(e)
  })
