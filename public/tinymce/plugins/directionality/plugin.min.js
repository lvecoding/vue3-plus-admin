!(function () {
  ...
  const c = t => {
    ...
    b = t =>
      ...
      ((t, e) => {
        ...
        return '' !== o || w(t)
          ? o
          : ((t, e) => ((t => void 0 !== t.style && i(t.style.getPropertyValue))(t) ? t.style.getPropertyValue(e) : ''))(r, e)
      })(t, 'direction')
        ? 'rtl'
        : 'ltr',
    S = (t, e) =>
  ...
  const A = (t, e, n) => {
    ...
    C = (t, e) => r => {
      ...
      return t.on('NodeChange', o), r.setEnabled(t.selection.isEditable()), () => t.off('NodeChange', o)
    }
