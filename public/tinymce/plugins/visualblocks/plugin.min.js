!(function () {
  ...
  t.add('visualblocks', (t, l) => {
    ;(t => {
      ;(0, t.options.register)('visualblocks_default_state', { processor: 'boolean', default: !1 })
    })(t)
    const a = (() => {
      let t = !1
      return {
    ...
    ;((t, e, s) => {
      ...
      ((t, s, l) => {
        t.on('PreviewFormats AfterPreviewFormats', o => {
          l.get() && t.dom.toggleClass(t.getBody(), 'mce-visualblocks', 'afterpreviewformats' === o.type)
        }),
          t.on('init', () => {
            e(t) && o(t, 0, l)
          })
