!(function () {
  ...
  const e = (t, e, s) => {
      ...
      t.execCommand(r, !1, !1 === s ? null : { 'list-style-type': s })
    },
  ...
  class o {
    ...
    map(t) {
      return this.tag ? o.some(t(this.value)) : o.none()
    }
    bind(t) {
      return this.tag ? t(this.value) : o.none()
    }
    exists(t) {
    ...
    filter(t) {
      return !this.tag || t(this.value) ? this : o.none()
    }
    getOr(t) {
  ...
  const a = Array.prototype.indexOf,
    u = Object.keys
  var d = tinymce.util.Tools.resolve('tinymce.util.Tools')
  const c = t => e => i(e) && t.test(e.nodeName),
    h = c(/^(OL|UL|DL)$/),
    g = c(/^(TH|TD)$/),
    p = t => (l(t) || 'default' === t ? '' : t),
    m = (t, e) => s =>
      ((t, e) => {
        ...
        return e({ parents: t.dom.getParents(s), element: s }), t.on('NodeChange', e), () => t.off('NodeChange', e)
      })(t, r =>
        ((t, r) => {
          const n = t.selection.getStart(!0)
          s.setActive(
            ((t, e, s) =>
              ((t, e, s) => {
                for (let e = 0, n = t.length; e < n; e++) {
                  const n = t[e]
                  if (h((r = n)) && !/\btox\-/.test(r.className)) return o.some(n)
                  if (s(n, e)) break
                }
                var r
                return o.none()
              })(e, 0, g).exists(e => e.nodeName === s && ((t, e) => t.dom.isChildOf(e, t.getBody()))(t, e)))(t, r, e)
          ),
            s.setEnabled(
              !((t, e) => {
                const s = t.dom.getParent(e, 'ol,ul,dl')
                return ((t, e) => null !== e && !t.dom.isEditable(e))(t, s) || !t.selection.isEditable()
              })(t, n)
            )
        })(t, r.parents)
      ),
    v = (t, s, r, n, l, i) => {
      ...
      t.ui.registry.addSplitButton(s, {
          ...
          t(
            d.map(i, t => {
              const e = 'OL' === l ? 'num' : 'bull',
                s = 'decimal' === t ? 'default' : t,
                r = p(t),
                n = (t => t.replace(/\-/g, ' ').replace(/\b\w/g, t => t.toUpperCase()))(t)
              return { type: 'choiceitem', value: r, icon: 'list-' + e + '-' + s, text: n }
            })
          )
        },
        ...
        select: e => {
          ...
          return s.exists(t => e === t || (c[t] === e && !h[e]))
        },
        onSetup: m(t, l)
      })
    },
    ...
    t.hasPlugin('lists')
      ? ((t => {
          ...
          e('advlist_number_styles', {
            ...
            e('advlist_bullet_styles', { processor: 'string[]', default: 'default,disc,circle,square'.split(',') })
        })(t),
        (t => {
          y(t, 'numlist', 'Numbered list', 'InsertOrderedList', 'OL', r(t)),
            y(t, 'bullist', 'Bullet list', 'InsertUnorderedList', 'UL', n(t))
        })(t),
        (t => {
