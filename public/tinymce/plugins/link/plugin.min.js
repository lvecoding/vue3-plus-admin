!(function () {
          ...
          : 'object' === t && Array.isArray(e)
            ...
            : 'object' === t &&
                ...
                (r = String).prototype.isPrototypeOf(n) ||
                  (null === (l = o.constructor) || void 0 === l ? void 0 : l.name) === r.name)
              ? 'string'
              : t
        var n, o, r, l
      })(t) === e,
  ...
  ;(m.singletonNone = new m(!1)), Array.prototype.slice
  ...
  const k = (e, t) => {
    ...
    w = (e, t) => (e ? m.some(t) : m.none()),
    C = e => t => t.options.get(e),
    A = C('link_assume_external_targets'),
    O = C('link_context_toolbar'),
    S = C('link_list'),
    N = C('link_default_target'),
    E = C('link_default_protocol'),
    R = C('link_target_list'),
    T = C('link_rel_list'),
    L = C('link_class_list'),
    P = C('link_title'),
    M = C('allow_unsafe_link_target'),
    D = C('link_quicklink'),
    B = C('link_attributes_postprocess')
  ...
  const U = e => i(e) && 'a' === e.nodeName.toLowerCase(),
    q = e => U(e) && !!$(e),
    F = (e, t) => {
    ...
    $ = e => {
      var t, n
      return null !== (n = null !== (t = e.getAttribute('data-mce-href')) && void 0 !== t ? t : e.getAttribute('href')) &&
        void 0 !== n
        ? n
        : ''
    },
    ...
    G = (e, t) => (
      (t = t || W(e.selection.getRng())[0] || e.selection.getNode()),
      Z(t) ? m.from(e.dom.select('a[href]', t)[0]) : m.from(e.dom.getParent(t, 'a[href]'))
    ),
    H = (e, t) => G(e, t).isSome(),
    J = (e, t) =>
      t
    ...
    Z = e => i(e) && 'FIGURE' === e.nodeName && /\bimage\b/i.test(e.className),
    ee = (e, t, n) => {
      const o = e.selection.getNode(),
        ...
        l = ((e, t) => {
          ...
          return (
            m.from(n.target).isNone() && !1 === R(e) && (n.target = N(e)),
            (n.href = ((e, t) => (('http' !== t && 'https' !== t) || V(e) ? e : t + '://' + e))(n.href, A(e))),
            n
          )
        })(
          e,
    ...
    te = e => {
      const { class: t, href: n, rel: o, target: r, text: l, title: a } = e
      return (e => {
        const t = {}
        var n
        return (
      ...
      })({ class: t.getOrNull(), href: n, rel: o.getOrNull(), target: r.getOrNull(), text: l.getOrNull(), title: a.getOrNull() })
    },
    ne = (e, t, n) => {
      const o = ((e, t) => {
        const n = e.options.get,
          ...
          r = t.href
        return { ...t, href: I.isDomSafe(r, 'a', o) ? r : '' }
      })(e, n)
    ...
    ae = (e, t) => {
      ...
      return (
        j.each(e, e => {
          ...
          if (void 0 !== e.menu) {
            const o = ae(e.menu, t)
            n.push({ text: r, items: o })
          } else {
            const o = t(e)
            n.push({ text: r, value: o })
          }
        }),
        n
      )
    ...
    ie =
      (e = se) =>
      t =>
        m.from(t).map(t => ae(t, e)),
    ce = e => ie(se)(e),
    ue = ie,
    ge = (e, t) => n => ({ name: e, type: 'listbox', label: t, items: n }),
    de = se,
    me = (e, t) =>
      k(t, t =>
        (e => {
    ...
    he = (e, t) => {
      const n = { text: e.text, title: e.title },
        o = (e, o) => {
          ...
          return ((e, t, n, o) => {
            const r = o[t],
              l = e.length > 0
            return void 0 !== r
              ? me(r, n).map(t => ({ url: { value: t.value, meta: { text: l ? e : t.text, attach: g } }, text: l ? e : t.text }))
              : m.none()
          })(n.text, o, r, e)
        }
      return {
        onChange: (e, t) => {
          ...
          return 'url' === r
            ? (e => {
                const t =
                  ((o = e.url),
                  w(n.text.length <= 0, m.from(null === (r = o.meta) || void 0 === r ? void 0 : r.text).getOr(o.value)))
                var o, r
                const l = (e => {
                  var t
                  return w(n.title.length <= 0, m.from(null === (t = e.meta) || void 0 === t ? void 0 : t.title).getOr(''))
                })(e.url)
                return t.isSome() || l.isSome()
                  ? m.some({ ...t.map(e => ({ text: e })).getOr({}), ...l.map(e => ({ title: e })).getOr({}) })
                  : m.none()
              })(e())
            : ((e, t) => h.call(e, t))(['anchor', 'link'], r) > -1
              ? o(e(), r)
              : 'text' === r || 'title' === r
                ? ((n[r] = e()[r]), m.none())
                : m.none()
  ...
  const fe = e => {
      const t = e.href
      return t.indexOf('@') > 0 && -1 === t.indexOf('/') && -1 === t.indexOf('mailto:')
        ? m.some({
    ...
    Ae = (e, t) =>
      (e => {
        ...
        return new Promise(e => {
          o(n)
            ? fetch(n)
                .then(e => (e.ok ? e.text().then(be) : Promise.reject()))
                .then(e, () => e(m.none()))
            : c(n)
              ? n(t => e(m.some(t)))
              : e(m.from(n))
        }).then(e => e.bind(ue(t)).map(e => (e.length > 0 ? [{ text: 'None', value: '' }].concat(e) : e)))
      })(e).then(n => {
        const o = ((e, t) => {
          const n = e.dom,
            ...
            a = t.bind(e => Ce(n, e, 'class'))
          return { url: r, text: o, title: t.bind(e => Ce(n, e, 'title')), target: l, rel: s, linkClass: a }
        })(e, t)
        return {
          anchor: o,
          catalogs: { targets: we(e), rels: xe(e, o.target), classes: ye(e), anchor: ve(e), link: n },
          optNode: t,
          flags: { titleEnabled: P(e) }
        }
      }),
    Oe = e => {
      const t = (e => {
      ...
      t.then(t => {
        const n = ((e, t) => n => {
          ...
          const r = e => m.from(o[e]).filter(n => !x(t.anchor[e], n)),
            l = {
              href: o.url.value,
              text: r('text'),
              target: r('target'),
            ...
            s = { href: o.url.value, attach: void 0 !== o.url.meta && o.url.meta.attach ? o.url.meta.attach : g }
          ;((e, t) =>
            k([fe, ke(A(e), E(e))], e => e(t)).fold(
              () => Promise.resolve(t),
              n =>
                new Promise(o => {
                  ;((e, t, n) => {
        ...
        return ((e, t, n) => {
          const o = e.anchor.text.map(() => ({ name: 'text', type: 'input', label: 'Text to display' })).toArray(),
            r = e.flags.titleEnabled ? [{ name: 'title', type: 'input', label: 'Title' }] : [],
            l = ((e, t) => {
              const n = e.anchor,
                o = n.url.getOr('')
              return {
                url: { value: o, meta: { original: { value: o } } },
                text: n.text.getOr(''),
                title: n.title.getOr(''),
                anchor: o,
                link: o,
          ...
          return {
            ...
            body: {
              type: 'panel',
              items: f([
                [{ name: 'url', type: 'urlinput', filetype: 'file', label: 'URL', picker_text: 'Browse links' }],
                o,
                r,
                _([
                  s.anchor.map(ge('anchor', 'Anchors')),
                  s.rels.map(ge('rel', 'Rel')),
                  s.targets.map(ge('target', 'Open link in...')),
                  s.link.map(ge('link', 'Link list')),
                  s.classes.map(ge('linkClass', 'Class'))
                ])
              ])
            },
            buttons: [
            ...
            initialData: l,
            onChange: (e, { name: t }) => {
              a.onChange(e.getData, { name: t }).each(t => {
                e.setData(t)
              })
            },
            onSubmit: t
  ...
  const Ne = (e, t) => {
      if (t) {
        ...
        if (/^#/.test(o)) {
          const t = e.dom.select(
            `${o},[name="${((n = o), ((e, t) => ((e, t) => '' === t || (e.length >= t.length && e.substr(0, 0 + t.length) === t))(e, t))(n, '#') ? (e => e.substring(1))(n) : n)}"]`
          )
          ...
          (e => {
            ...
            const n = new MouseEvent('click', { bubbles: !0, cancelable: !0, view: window })
    ...
    Re = e =>
      ...
      (e => {
        ...
        ? Ee(e, e.selection.getStart())
        : (e => {
            const t = W(e.selection.getRng())
            return w(t.length > 0, t[0]).or(Ee(e, e.selection.getNode()))
          })(e),
    Te = e => () => {
    ...
    Be = e => {
      const t = (e => {
        ...
        return (
          ...
          e.on('click', n => {
            ...
            1 === o.length && Se.metaKeyPressed(n) && (n.preventDefault(), Ne(e, o[0]))
          }),
          e.on('keydown', o => {
            t.clear(),
              !o.isDefaultPrevented() &&
                13 === o.keyCode &&
                (e => !0 === e.altKey && !1 === e.shiftKey && !1 === e.ctrlKey && !1 === e.metaKey)(o) &&
                n().each(t => {
      ...
      ;((e, t) => {
        e.ui.registry.addToggleButton('link', {
          ...
          e.ui.registry.addButton('unlink', { icon: 'unlink', tooltip: 'Remove link', onAction: () => oe(e), onSetup: De(e) })
      })(e, t),
        ((e, t) => {
          e.ui.registry.addMenuItem('openlink', {
            ...
            e.ui.registry.addMenuItem('unlink', { icon: 'unlink', text: 'Remove link', onAction: () => oe(e), onSetup: De(e) })
        })(e, t),
        (e => {
        ...
        ((e, t) => {
          ...
          e.ui.registry.addContextForm('quicklink', {
            launch: { type: 'contextformtogglebutton', icon: 'link', tooltip: 'Link', onSetup: Pe(e) },
            label: 'Link',
            predicate: t => O(e) && H(e, t),
            initValue: () => G(e).fold(() => '', $),
            commands: [
              {
                ...
                onAction: t => {
                  ...
                  ne(
                    e,
                    { href: n, attach: g },
                    { href: n, text: o, title: m.none(), rel: m.none(), target: m.from(N(e)), class: m.none() }
                  ),
                    (e => {
  ...
  e.add('link', e => {
    ;(e => {
      ...
      t('link_assume_external_targets', {
        ...
        t('link_attributes_postprocess', { processor: 'function' })
    })(e),
      (e => {
        e.addCommand('mceLink', (t, n) => {
          !0 !== (null == n ? void 0 : n.dialog) && D(e) ? e.dispatch('contexttoolbar-show', { toolbarKey: 'quicklink' }) : Oe(e)
        })
      })(e),
      Be(e),
      (e => {
