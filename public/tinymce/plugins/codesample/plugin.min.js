!(function () {
  ...
  const l = (function () {
        ...
        var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
          ...
          s = {
              ...
              clone: function e(t, n) {
                ...
                switch (((n = n || {}), s.util.type(t))) {
                  case 'Object':
                    ...
                    for (var i in ((a = {}), (n[r] = a), t)) t.hasOwnProperty(i) && (a[i] = e(t[i], n))
                    return a
                  case 'Array':
                    return (
                      (r = s.util.objId(t)),
                ...
                for (var o in t)
                  if (t.hasOwnProperty(o)) {
                    ...
                    var l = t[o],
                      u = s.util.type(l)
                    'Object' !== u || r[i(l)]
                      ? 'Array' !== u || r[i(l)] || ((r[i(l)] = !0), e(l, n, o, r))
            ...
            highlightAllUnder: function (e, t, n) {
              ...
              for (var r, i = 0; (r = a.elements[i++]); ) s.highlightElement(r, !0 === t, a.callback)
            },
                ...
                for (
                  ...
                  if (!(F instanceof r)) {
                    var A,
                      S = 1
                    if (y) {
                      if (!(A = i(v, x, e, m)) || A.index >= e.length) break
                      var $ = A.index,
                        z = A.index + A[0].length,
                        E = x
                      for (E += _.value.length; $ >= E; ) E += (_ = _.next).value.length
                      if (((x = E -= _.value.length), _.value instanceof r)) continue
                      for (var C = _; C !== t.tail && (E < z || 'string' == typeof C.value); C = C.next)
                        S++, (E += C.value.length)
                      S--, (F = e.slice(x, E)), (A.index -= x)
                    } else if (!(A = i(v, 0, F, m))) continue
                    $ = A.index
                    var j = A[0],
                      B = F.slice(0, $),
                      T = F.slice($ + j.length),
                    ...
                    if (
                      ...
                      var N = { cause: g + ',' + b, reach: O }
                      o(e, t, n, _.prev, x, N), d && N.reach > d.reach && (d.reach = N.reach)
                    }
                  }
                }
              }
                ...
                e.addEventListener(
                  ...
                  function (t) {
                    var n = JSON.parse(t.data),
                      ...
                      r = n.code,
                      i = n.immediateClose
                    e.postMessage(s.highlight(r, s.languages[a], a)), i && e.close()
                  },
                  !1
                ),
              s)
       ...
       */ return (
              ...
              value: function (n, a, s, r) {
                if (n.language === a) {
                  ...
                  ;(n.code = n.code.replace(s, function (e) {
                    ...
                    for (var s, o = i.length; -1 !== n.code.indexOf((s = t(a, o))); ) ++o
                    return (i[o] = e), s
                  })),
                      ...
                      if ('string' == typeof u || (u.content && 'string' == typeof u.content)) {
                        ...
                        if (b > -1) {
                          ...
                          h && y.push.apply(y, i([h])),
                            ...
                            'string' == typeof u ? o.splice.apply(o, [l, 1].concat(y)) : (u.content = y)
                        }
        ...
        (function (e) {
          ...
          var s = 'bool byte char decimal double dynamic float int long object sbyte short string uint ulong ushort var void',
          ...
          ;(e.languages.csharp = e.languages.extend('clike', {
            string: [
              ...
              { pattern: n(/(^|[^@$\\])<<0>>/.source, [A]), lookbehind: !0, greedy: !0 }
            ],
            'class-name': [
              { pattern: n(/(\busing\s+static\s+)<<0>>(?=\s*;)/.source, [m]), lookbehind: !0, inside: x },
              { pattern: n(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [h, _]), lookbehind: !0, inside: x },
              { pattern: n(/(\busing\s+)<<0>>(?=\s*=)/.source, [h]), lookbehind: !0 },
              { pattern: n(/(\b<<0>>\s+)<<1>>/.source, [u, f]), lookbehind: !0, inside: x },
              { pattern: n(/(\bcatch\s*\(\s*)<<0>>/.source, [m]), lookbehind: !0, inside: x },
              { pattern: n(/(\bwhere\s+)<<0>>/.source, [h]), lookbehind: !0 },
              { pattern: n(/(\b(?:is(?:\s+not)?|as)\s+)<<0>>/.source, [w]), lookbehind: !0, inside: x },
              {
                pattern: n(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [_, g, h]),
                inside: x
              }
            ],
            keyword: c,
            ...
            e.languages.insertBefore('csharp', 'punctuation', {
              'named-parameter': { pattern: n(/([(,]\s*)<<0>>(?=\s*:)/.source, [h]), lookbehind: !0, alias: 'punctuation' }
            }),
            e.languages.insertBefore('csharp', 'class-name', {
              ...
              'return-type': {
                pattern: n(/<<0>>(?=\s+(?:<<1>>\s*(?:=>|[({]|\.\s*this\s*\[)|this\s*\[))/.source, [_, m]),
                inside: x,
                alias: 'class-name'
              },
              ...
              'generic-method': {
                ...
                inside: { function: n(/^<<0>>/.source, [h]), generic: { pattern: RegExp(p), alias: 'class-name', inside: x } }
              },
              'type-list': {
                pattern: n(
          ...
          e.languages.insertBefore('csharp', 'class-name', {
            attribute: {
              pattern: n(/((?:^|[^\s\w>)?])\s*\[\s*)(?:<<0>>\s*:\s*)?<<1>>(?:\s*,\s*<<1>>)*(?=\s*\])/.source, [C, j]),
              lookbehind: !0,
              greedy: !0,
              inside: {
                target: { pattern: n(/^<<0>>(?=\s*:)/.source, [C]), alias: 'keyword' },
                'attribute-arguments': { pattern: n(/\(<<0>>*\)/.source, [E]), inside: e.languages.csharp },
          ...
          e.languages.insertBefore('csharp', 'string', {
            'interpolation-string': [
              {
                pattern: n(/(^|[^\\])(?:\$@|@\$)"(?:""|\\[\s\S]|\{\{|<<0>>|[^\\{"])*"/.source, [O]),
                lookbehind: !0,
                greedy: !0,
                inside: R(O, T)
              },
              { pattern: n(/(^|[^@\\])\$"(?:\\.|\{\{|<<0>>|[^\\"{])*"/.source, [N]), lookbehind: !0, greedy: !0, inside: R(N, P) }
            ],
              ...
              import: [
                {
                  ...
                  lookbehind: !0,
                  inside: { namespace: a.inside.namespace, punctuation: /\./, operator: /\*/, 'class-name': /\w+/ }
                },
                {
        ...
        Object.defineProperty(t.languages.markup.tag, 'addInlined', {
          value: function (e, n) {
            var a = {}
            ;(a['language-' + n] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: t.languages[n] }),
              (a.cdata = /^<!\[CDATA\[|\]\]>$/i)
        ...
        (function (e) {
          ...
          var i = {
            ...
            o = [
              ...
              { pattern: /"(?:\\[\s\S]|[^\\"])*"/, alias: 'double-quoted-string', greedy: !0, inside: { interpolation: i } }
            ]
        ...
        (function (e) {
          ...
          e.languages.insertBefore('ruby', 'keyword', {
            ...
            symbol: [
              ...
              { pattern: RegExp(/([\r\n{(,][ \t]*)/.source + a + /(?=:(?!:))/.source), lookbehind: !0, greedy: !0 }
            ],
            'method-definition': {
              ...
              'command-literal': [
                {
                  ...
                  greedy: !0,
                  inside: { interpolation: t, command: { pattern: /[\s\S]+/, alias: 'string' } }
                },
                {
                  pattern: /`(?:#\{[^}]+\}|#(?!\{)|\\(?:\r\n|[\s\S])|[^\\`#\r\n])*`/,
                  greedy: !0,
    ...
    g = e => (s.Prism && d(e) ? s.Prism : l),
    p = e => t(e) && 'PRE' === e.nodeName && -1 !== e.className.indexOf('language-'),
    b = e => {
      const t = e.selection ? e.selection.getNode() : null
      return p(t) ? a.some(t) : a.none()
    },
    h = e => {
      const t = (e =>
          c(e) || [
        ...
        n = ((s = t), (e => (0 < e.length ? a.some(e[0]) : a.none()))(s)).fold(
          () => '',
          e => e.value
        )
      var s
      const r = ((e, t) =>
          b(e).fold(
            () => t,
            e => {
              const n = e.className.match(/language-(\w+)/)
              return n ? n[1] : t
            }
          ))(e, n),
        i = (e =>
          b(e)
            .bind(e => a.from(e.textContent))
            .getOr(''))(e)
      e.windowManager.open({
        ...
        body: {
          type: 'panel',
          items: [
            { type: 'listbox', name: 'language', label: 'Language', items: t },
            { type: 'textarea', name: 'code', label: 'Code view' }
          ]
        },
        buttons: [
              ...
              return (
                ...
                s.fold(
                  () => {
                    ...
                    const s = a.select('#__new')[0]
                    a.setAttrib(s, 'id', null), e.selection.select(s)
                  },
                  s => {
                    a.setAttrib(s, 'class', 'language-' + t), (s.innerHTML = n), g(e).highlightElement(s), e.selection.select(s)
                  }
                )
              )
            })
  ...
  const m =
    ...
    n => {
      const a = () => {
        n.setEnabled(e.selection.isEditable()), t(n)
      }
      return (
        e.on('NodeChange', a),
        a(),
  ...
  e.add('codesample', e => {
    ;(e => {
      ...
      t('codesample_languages', { processor: 'object[]' }), t('codesample_global_prismjs', { processor: 'boolean', default: !1 })
    })(e),
      (e => {
        e.on('PreProcess', t => {
          const n = e.dom,
            a = n.select('pre[contenteditable=false]', t.node)
          f.each(f.grep(a, p), e => {
            const t = e.textContent
            let a
            for (
              n.setAttrib(e, 'class', r(n.getAttrib(e, 'class'))),
                n.setAttrib(e, 'contentEditable', null),
                n.setAttrib(e, 'data-mce-highlighted', null);
              (a = e.firstChild);

            )
              e.removeChild(a)
            n.add(e, 'code').textContent = t
          })
        }),
          e.on('SetContent', () => {
            const t = e.dom,
              n = f.grep(t.select('pre'), e => p(e) && 'true' !== t.getAttrib(e, 'data-mce-highlighted'))
            n.length &&
              e.undoManager.transact(() => {
                f.each(n, n => {
                  var a
                  f.each(t.select('br', n), n => {
                    t.replace(e.getDoc().createTextNode('\n'), n)
                  }),
                    (n.innerHTML = t.encode(null !== (a = n.textContent) && void 0 !== a ? a : '')),
                    g(e).highlightElement(n),
                    t.setAttrib(n, 'data-mce-highlighted', !0),
                    (n.className = r(n.className))
                })
              })
          }),
          e.on('PreInit', () => {
            e.parser.addNodeFilter('pre', e => {
              var t
              for (let n = 0, a = e.length; n < a; n++) {
                const a = e[n]
                ;-1 !== (null !== (t = a.attr('class')) && void 0 !== t ? t : '').indexOf('language-') &&
                  (a.attr('contenteditable', 'false'), a.attr('data-mce-highlighted', 'false'))
              }
            })
          })
      })(e),
      (e => {
        const t = () => e.execCommand('codesample')
        e.ui.registry.addToggleButton('codesample', {
          icon: 'code-sample',
          ...
          onSetup: m(e, t => {
            t.setActive(
              (e => {
                ...
                return e.dom.is(t, 'pre[class*="language-"]')
              })(e)
            )
          })
        }),
          e.ui.registry.addMenuItem('codesample', { text: 'Code sample...', icon: 'code-sample', onAction: t, onSetup: m(e) })
      })(e),
      (e => {
        e.addCommand('codesample', () => {
          const t = e.selection.getNode()
          e.selection.isCollapsed() || p(t) ? h(e) : e.formatter.toggle('code')
        })
      })(e),
      e.on('dblclick', t => {
        p(t.target) && h(e)
