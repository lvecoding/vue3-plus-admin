!(function () {
  ...
  const n = e => e.options.get('allow_html_in_named_anchor')
  const a = 'a:not([href])',
    r = e => !e,
    i = e => e.getAttribute('id') || e.getAttribute('name') || '',
    l = e => (e => 'a' === e.nodeName.toLowerCase())(e) && !e.getAttribute('href') && '' !== i(e),
    s = e => e.dom.getParent(e.selection.getStart(), a),
    d = (e, a) => {
      const r = s(e)
      r
        ? ((e, t, o) => {
            o.removeAttribute('name'), (o.id = t), e.addVisual(), e.undoManager.add()
          })(e, a, r)
        : ((e, a) => {
    ...
    c = e => (e => r(e.attr('href')) && !r(e.attr('id') || e.attr('name')))(e) && !e.firstChild,
    m = e => t => {
  ...
  e.add('anchor', e => {
    ;(e => {
      ;(0, e.options.register)('allow_html_in_named_anchor', { processor: 'boolean', default: !1 })
    })(e),
      (e => {
        e.on('PreInit', () => {
      ...
      (e => {
        ...
        e.ui.registry.addToggleButton('anchor', {
          ...
          onAction: t,
          onSetup: t => {
            const o = e.selection.selectorChangedWithUnbind('a:not([href])', t.setActive).unbind,
              n = u(e)(t)
            return () => {
              o(), n()
            }
          ...
          e.ui.registry.addMenuItem('anchor', { icon: 'bookmark', text: 'Anchor...', onAction: t, onSetup: u(e) })
      })(e),
      e.on('PreInit', () => {
        ;(e => {
