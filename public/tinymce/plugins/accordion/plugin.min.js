!(function () {
  ...
  const b = (e, t) => ({ element: e, offset: t }),
    ...
    C = e => (1 !== e.nodeType && 9 !== e.nodeType && 11 !== e.nodeType) || 0 === e.childElementCount,
    S = A,
  ...
  const te = (e, t, o) =>
      (e.property().isText(t) && 0 === e.property().getText(t).trim().length) || e.property().isComment(t)
        ...
        : m.none(),
    oe = (e, t) => (e.property().isText(t) ? e.property().getText(t).length : e.property().children(t).length),
    ne = (e, t) => {
    ...
    se = {
      up: l({
        selector: W,
        closest: (e, t, o) =>
          ((e, t, o, n, r) => (((e, t) => A(e, t))(o, n) ? m.some(o) : a(r) && r(o) ? m.none() : t(o, n, r)))(0, W, e, t, o),
        predicate: Q,
        all: (e, t) => {
          const o = a(t) ? t : c
          let n = e.dom
      ...
      property: l({
        ...
        isSpecial: e => {
          const t = x(e)
          return g(['script', 'noscript', 'iframe', 'noframes', 'noembed', 'title', 'style', 'textarea', 'xmp'], t)
        },
  ...
  const ue = e => 'SUMMARY' === (null == e ? void 0 : e.nodeName),
    ...
    Ne = e => {
      ...
      e.undoManager.transact(() => {
        e.insertContent([`<details data-mce-id="${o}" class="${ie}" open="open">`, s, a, '</details>'].join('')),
          X(t, `[data-mce-id="${o}"]`).each(t => {
            K(t, 'data-mce-id'),
              X(t, 'summary').each(t => {
                const o = e.dom.createRng(),
                  n = re(se, t)
                o.setStart(n.element.dom, n.offset), o.setEnd(n.element.dom, n.offset), e.selection.setRng(o)
              })
          })
      })
    },
  ...
  const Se = e => {
    ...
    Oe = e => {
      ...
      for (let e = 0; e < t.length; e++) {
        const i = t[e]
        'summary' === i.name && r(o) ? (o = i) : (a = i).name === ce && g(Se(a), de) && r(n) ? (n = i) : s.push(i)
      }
      var a
  ...
  e.add('accordion', e => {
    ;(e => {
      ...
      e.ui.registry.addButton('accordion', { icon: 'accordion', tooltip: 'Insert accordion', onSetup: Be(e), onAction: t }),
        e.ui.registry.addMenuItem('accordion', { icon: 'accordion', text: 'Accordion', onSetup: Be(e), onAction: t }),
        ...
        e.ui.registry.addContextToolbar('accordion', {
          predicate: t => e.dom.is(t, 'details') && e.getBody().contains(t) && e.dom.isEditable(t.parentNode),
          ...
          o.addNodeFilter(ae, e => {
            for (let t = 0; t < e.length; t++) {
              ...
              if (Ee(o)) {
                ...
                r(l.firstChild) && Me(l), xe(l, [le]), i || (s(e.firstChild) ? e.insert(l, e.firstChild, !0) : e.append(l))
                const d = s(n),
                  c = d ? n : new Ce(ce, 1)
        ...
        ke.browser.isSafari() &&
          e.on('click', t => {
            if (ue(t.target)) {
              ...
              n.collapsed && n.startContainer === o.parentNode && 0 === n.startOffset && e.selection.setCursorLocation(o, 0)
            }
          })
      })(e)
  })
