!(function () {
  ...
  const S = e => {
    ...
    x = s(
      [
        ...
        { key: 'typography', name: 'Advanced Typography', type: 'premium', slug: 'advanced-typography' },
        ...
        { key: 'mediaembed', name: 'Enhanced Media Embed', type: 'premium', slug: 'introduction-to-mediaembed' },
        ...
        { key: 'powerpaste', name: 'PowerPaste', type: 'premium', slug: 'introduction-to-powerpaste' },
        { key: 'revisionhistory', name: 'Revision History', type: 'premium' },
        { key: 'tinymcespellchecker', name: 'Spell Checker', type: 'premium', slug: 'introduction-to-tiny-spellchecker' },
        ...
        { key: 'tinycomments', name: 'Tiny Comments', type: 'premium', slug: 'introduction-to-tiny-comments' },
        { key: 'tinydrive', name: 'Tiny Drive', type: 'premium', slug: 'tinydrive-introduction' }
      ],
      e => ({ ...e, type: e.type || 'opensource', slug: e.slug || e.key })
    ),
    T = e => {
      const o = e => `<a data-alloy-tabstop="true" tabindex="-1" href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
        u = (e, t) => {
          return ((i = x),
          (s = e => e.key === t),
          ((e, t, n) => {
            ...
            e => {
              ...
              return { name: t, html: o({ name: t, url: `https://www.tiny.cloud/docs/tinymce/7/${e.slug}/` }) }
            }
          )
          var i, s
        },
        p = e => {
          const n = (e => {
            ...
            o = r.length,
            p = r.join('')
          return '<p><b>' + f.translate(['Plugins installed ({0}):', o]) + '</b></p><ul>' + p + '</ul>'
        },
        y = {
          type: 'htmlpanel',
          presets: 'document',
      ...
      const o = _(),
        ...
        m = (() => {
          ...
          const n =
            ...
            ((e = O.majorVersion), (t = O.minorVersion), (0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) + '</a>')
          return {
            name: 'versions',
            title: 'Version',
            items: [{ type: 'htmlpanel', html: '<p>' + f.translate(['You are using {0}', n]) + '</p>', presets: 'document' }]
          }
        })(),
  ...
  d.add('help', (e, t) => {
    ...
    return (
      ((e, t) => {
        e.ui.registry.addButton('help', { icon: 'help', tooltip: 'Help', onAction: t, context: 'any' }),
          e.ui.registry.addMenuItem('help', { text: 'Help', icon: 'help', shortcut: 'Alt+0', onAction: t, context: 'any' })
      })(e, r),
      ((e, t) => {
