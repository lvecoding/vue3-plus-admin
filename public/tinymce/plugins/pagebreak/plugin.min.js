!(function () {
  ...
  e.add('pagebreak', e => {
    ;(e => {
      ...
      a('pagebreak_separator', { processor: 'string', default: '\x3c!-- pagebreak --\x3e' }),
      ...
      (e => {
        ...
        e.ui.registry.addButton('pagebreak', { icon: 'page-break', tooltip: 'Page break', onAction: a, onSetup: c(e) }),
          ...
          e.on('PreInit', () => {
            e.serializer.addNodeFilter('img', n => {
              let o,
                ...
                c = n.length
              for (; c--; )
                if (((o = n[c]), (s = o.attr('class')), s && -1 !== s.indexOf(r))) {
                  const n = o.parent
      ...
      (e => {
        e.on('ResolveName', a => {
          'IMG' === a.target.nodeName && e.dom.hasClass(a.target, r) && (a.name = 'pagebreak')
        })
      })(e)
  })
})()
