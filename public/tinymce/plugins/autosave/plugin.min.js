!(function () {
  ...
  const n = t => {
    ...
    f = t => {
      var e
      const r = parseInt(null !== (e = a.getItem(m(t) + 'time')) && void 0 !== e ? e : '0', 10) || 0
    ...
    g = t => {
      ...
      const r = m(t)
      f(t) &&
        (t.setContent(null !== (e = a.getItem(r + 'draft')) && void 0 !== e ? e : '', { format: 'raw' }),
        (t => {
  ...
  const h = t => e => {
    const r = () => f(t) && !t.mode.isReadOnly()
    e.setEnabled(r())
    const o = () => e.setEnabled(r())
    return t.on('StoreDraft RestoreDraft RemoveDraft', o), () => t.off('StoreDraft RestoreDraft RemoveDraft', o)
  }
  t.add(
    'autosave',
    t => (
      (t => {
        const r = t.options.register,
          o = t => {
            const r = e(t)
            return r ? { value: n(t), valid: r } : { valid: !1, message: 'Must be a string.' }
          }
        r('autosave_ask_before_unload', { processor: 'boolean', default: !0 }),
          r('autosave_prefix', { processor: 'string', default: 'tinymce-autosave-{path}{query}{hash}-{id}-' }),
          r('autosave_restore_when_empty', { processor: 'boolean', default: !1 }),
        ...
        t.editorManager.on('BeforeUnload', t => {
          ...
          s.each(D.get(), t => {
            t.plugins.autosave && t.plugins.autosave.storeDraft(),
              !e && t.isDirty() && u(t) && (e = t.translate('You have unsaved changes are you sure you want to navigate away?'))
          }),
      ...
      t.on('init', () => {
        l(t) && t.dom.isEmpty(t.getBody()) && g(t)
      }),
      (t => ({
        hasDraft: () => f(t),
        storeDraft: () => y(t),
